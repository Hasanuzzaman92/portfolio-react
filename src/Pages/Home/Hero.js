      ...
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className="lg:w-1/2 sm:w-full p-5">
          <h1 className="text-4xl lg:text-5xl font-bold">
            Hi! <br /> I am{" "}
            <span className="text-amber-500">Md: Hasanuzzaman</span>
          </h1>
          ...
          <p className="py-6 text-justify">
            I am web developer with an amazing ability to develop website. I am
            self-motivated, energetic, passionate, quick-learner and ever ready
            to learn new thing. I am confident to ensure the highest level of
            professionalism. I have a good understanding with web standard and
            best practice.
          </p>
          <a
